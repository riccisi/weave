...
export default [// ignora build/cache/output
{ ignores: ["dist/**", "coverage/**", ".vite/**", "node_modules/**"] }, // base JS consigliata
js.configs.recommended, // TypeScript (preset + parser)
...tseslint.configs.recommended, // blocco principale: TS + browser+node globals
{
    languageOptions: {
